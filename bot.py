...
ALLOWED_CHAT_ID = 7049794980          # Sirf yeh chat ID allowed hai

EXTERNAL_API_URL = ""                 # Yahan apna API URL daalna (agar hai)
...
def send_message(chat_id, text, reply_markup=None):
    ...
    data = {
        "chat_id": chat_id,
        "text": text,
        "parse_mode": "HTML"          # <pre> ke liye zaroori
    }
...
def main():
    ...
    while True:
        ...
        for update in updates.get("result", []):
            ...
            # Sirf allowed chat ID pe respond karega
